...
-- removing and retaining paste buffer
...
require('lazy').setup({
  ...
  {
    'github/copilot.vim',
    -- set up the copilot config so that i can turn it on and off with keybindings
    config = function()
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      vim.list_extend(ensure_installed, {
        ...
        'eslint-lsp', -- Used to lint JavaScript and TypeScript
      })
  ...
  -- THEMES
  -- Below are my themes, move the priority and init function to the theme you want to use
  {
    'Mofiqul/vscode.nvim',
  },
  {
