...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      -- NeoTree configuration here
      require("neo-tree").setup({
        window = {
          position = "left", -- Open NeoTree on the left
          width = 35,        -- Set width of NeoTree
        },
        filesystem = {
          filtered_items = {
            visible = true,
      ...
      -- Keymap for toggling NeoTree using '\'
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'toml', 'tsx', 'typescript', 'javascript', 'vimdoc', 'vim', 'wit' },
...
local on_attach = function(client, bufnr)
  ...
  -- Toggle inlay hints (useful for TypeScript/JavaScript)
